 ...
 * Description: Показывает путь или имя текущего шаблона на фронтенде (только для администраторов). В меню «Настройки» появится пункт Template Debug, где можно включить/выключить отображение и выбрать режим показа.
 * Version: 1.1
